...
function App() {
  ...
  return (
    <main className='bg-lightBlue h-screen w-full p-4 flex-col flex'>
      ...
      <iframe alt="Caleb Hearn, Friend Right Now" className="rounded" src="https://open.spotify.com/embed/track/1525qKTOc3G2KJNYRG3rSQ?utm_source=generator" width="100%" height="80" frameBorder="0" allowFullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
